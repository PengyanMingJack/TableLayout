...
public class TopMyIndicator extends LinearLayout {
    ...
    public TopMyIndicator(Context context) {
        super(context);

    }

    public TopMyIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public TopMyIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
